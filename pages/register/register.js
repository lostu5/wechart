...
var phoneNum = null, identifyCode = null, password = null, rePassword = null, userAccount = null, timer = 1, phoneExist = null,status="1";
...
Page({
  ...
  blur_user:function(e){
    var that=this;
        wx.request({  
        url: 'http://192.168.0.249:8080/spm/accountExist.do',
        data: {
        userAccount:e.detail.value
            },  
        header: {  
...
function thirdStep() { // 提交［密码］和［重新密码］  
  ...
  if (webUtils.submitPassword(userAccount, password, phoneNum, status)) {
    hintMsg = "注册成功"
    return true
  }
  hintMsg = "提交错误，请填写正确的信息!"
  return false
}  