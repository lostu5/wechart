...
function getBannerData() {
  var arr = ['../../images/banner01.jpg', '../../images/banner02.jpg', '../../images/banner03.jpg']
  return arr
}
/*
 * 首页 3个 广告 navnavtop数据
 */
  ...
  var arr = [
    {
      id: 1,
      mode: 'aspectFill',
      icon: "../../images/topearn.png",
      title: "我要赚"
    },
    {
      id: 2,
      mode: 'aspectFill',
      icon: "../../images/topcar.png",
      title: "抢车位"
    },
    {
      id: 3,
      mode: 'aspectFill',
      icon: "../../images/topphone.png",
      title: "充值"
    }
  ]
  return arr
...
/*
 * 首页 4个 广告 navnavmid数据
 */
function getmidNavData() {
  var arr = [
    {
      id: 1,
      mode: 'aspectFill',
      icon: "../../images/midshar.png",
      title: "共享车位",
      abstract:"能赚钱的车位"
    },
    {
...
module.exports = {
  ...
  getTopNavData: getTopNavData, 
  getmidNavData: getmidNavData,
  getTopIndexNavData: getTopIndexNavData,
